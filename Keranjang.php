...
<head>
    ...
    <title>gogoBeauty - Keranjang Ku</title>
        ...
        <div class="container"><img src="assets/img/herbeauty.png" style="width: 100px;"><a class="navbar-brand" href="index.php" style="font-size: 23px;">gogoBeauty</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                <form action="" method="get">
                    <input type="text" name="keyword" placeholder="Cari Produk.." autocomplete="off">
        ...
        <div class="row">
            <div class="col-12 col-lg-6">
                ...
                if (!isset($_SESSION['keranjang']) || empty($_SESSION['keranjang'])) :
                    echo "<script>
                        alert('Anda harus beli produk dulu!');
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <a href="hapus-barang.php?id=<?= $id_produk ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin menghapus produk?')">Hapus</a>
