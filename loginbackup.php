...
<body>
    <nav class="navbar navbar-light navbar-expand-md navigation-clean-button" style="background-color: #98FB98;">
        <div class="container"><img src="assets/img/herbeauty.png" style="width: 100px;"><a class="navbar-brand" href="index.php" style="font-size: 23px;">gogoBeauty</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav mr-auto">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="#">HOME</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="#">ABOUTB US</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="#">CONTACT</a></li>
                </ul><span class="navbar-text actions"> <a class="login" name="login" href="#" style="width: 12px;font-size: 26px;height: 15px;margin: 18px;">Log In</a><a class="btn btn-light action-button" role="button" href="#" style="background-color: rgb(206,207,234);font-size: 21px;">Sign Up</a></span>
            </div>
        </div>
    </nav>
    <div class="login-clean">
        <form method="post">
            ...
            <div class="form-group"><button class="btn btn-primary btn-block" type="submit" style="background-color: rgb(0,155,193);" name="login">Log In</button></div><a class="forgot" href="#">Forgot your email or password?</a>
        </form>
    </div>
